...
// Función auxiliar para formatear la fecha (puedes ponerla dentro de handleSubmit o fuera)
const formatDate = (dateString: string) => {
  if (!dateString) return null
  // Convierte '2000-12-31' -> ['2000', '12', '31'] -> ['31', '12', '2000'] -> '31-12-2000'
...
const handleSubmit = async () => {
  ...
  const payload = {
    ...
    fechaNacimiento: formatDate(formData.birthDate),
    formularios: [
      {
        alias: 'Principal',
  ...
  if (success) {
    ...
    notificationStore.showNotification(
      t('register.notifications.success', { name: formData.firstName }),
      'success',
    )
    router.push('/')
  } else {
        ...
        <div v-if="currentStep === 1" class="step-content fade-in">
          <div class="form-group">
            ...
            <input
              ...
              :placeholder="$t('register.account.username_placeholder')"
            />
          </div>
          <div class="form-group">
            ...
            <input
              ...
              :placeholder="$t('register.account.email_placeholder')"
              required
            />
          </div>
          <div class="form-group">
            ...
            <input
              ...
              :placeholder="$t('register.account.password_placeholder')"
              required
            />
          </div>
          <div class="form-group">
        ...
        <div v-if="currentStep === 2" class="step-content fade-in">
          <div class="form-group">
            ...
            <input
              ...
              :placeholder="$t('register.personal.name_placeholder')"
              required
            />
          </div>
          <div class="form-group">
            ...
            <input
              ...
              :placeholder="$t('register.personal.surname_placeholder')"
              required
            />
          </div>
          <div class="form-group">
            ...
            <input
              ...
              :placeholder="$t('register.personal.phone_placeholder')"
              required
            />
          </div>
          <div class="form-group">
            ...
            <div class="col-left">
              <div class="form-group">
                ...
                <select v-model="formData.gender">
                  <option value="" disabled selected>
                    {{ $t('register.additional.gender_placeholder') }}
                  </option>
                  <option value="Hombre">
                    {{ $t('profile.data.gender_options.male') || 'Hombre' }}
                  </option>
                  <option value="Mujer">
                    {{ $t('profile.data.gender_options.female') || 'Mujer' }}
                  </option>
              ...
              <div class="form-group">
                ...
                <select v-model="formData.size">
                  <option value="" disabled selected>
                    {{ $t('register.additional.size_placeholder') }}
                  </option>
              ...
              <div class="form-group">
                ...
                <input
                  type="number"
                  v-model="formData.footSize"
                  :placeholder="$t('register.additional.foot_size_placeholder')"
                />
              </div>
            </div>
